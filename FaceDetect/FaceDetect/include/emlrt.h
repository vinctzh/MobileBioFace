 ...
 */
#define EMLRT_VERSION_R2013A 0x2013A
#define EMLRT_VERSION_INFO  EMLRT_VERSION_R2013A
 ...
 */
EXTERN_C LIBEMLRT_API const mxArray *emlrtCreateFI(const mxArray *fimath, const mxArray *ntype, const char *fitype, const mxArray *fival);

/*
 * MATLAB INTERNAL USE ONLY :: Create a FI mxArray from a value mxArray
 */
EXTERN_C LIBEMLRT_API const mxArray *emlrtCreateFIR2013a(emlrtCTX aTLS, const mxArray *fimath, const mxArray *ntype, const char *fitype, const mxArray *fival, const bool fmIsLocal);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtExtSerializeEnd(struct emlrtExternalSim *aExternalSim);

/*
 * MATLAB INTERNAL USE ONLY :: Deserialize a byte
 */
EXTERN_C LIBEMLRT_API uint8_T emlrtExtDeserializeByte(struct emlrtExternalSim *aExternalSim);

/*
 * MATLAB INTERNAL USE ONLY :: Serialize a byte
 */
EXTERN_C LIBEMLRT_API void emlrtExtSerializeByte(struct emlrtExternalSim *aExternalSim, uint8_T b);

/*
 * MATLAB INTERNAL USE ONLY :: Deserialize a single
 */
EXTERN_C LIBEMLRT_API real32_T emlrtExtDeserializeSingle(struct emlrtExternalSim *aExternalSim);

/*
 * MATLAB INTERNAL USE ONLY :: Serialize a single
 */
EXTERN_C LIBEMLRT_API void emlrtExtSerializeSingle(struct emlrtExternalSim *aExternalSim, real32_T s);

/*
 * MATLAB INTERNAL USE ONLY :: Deserialize a double
 */
EXTERN_C LIBEMLRT_API real64_T emlrtExtDeserializeDouble(struct emlrtExternalSim *aExternalSim);

/*
 * MATLAB INTERNAL USE ONLY :: Serialize a double
 */
EXTERN_C LIBEMLRT_API void emlrtExtSerializeDouble(struct emlrtExternalSim *aExternalSim, real64_T d);

/*
 * MATLAB INTERNAL USE ONLY :: connect to external target
 */
EXTERN_C LIBEMLRT_API void emlrtExtConnect(struct emlrtExternalSim *aExternalSim, const uint32_T aChecksum[4], const char *aMexArgs, const char *aMethod);

/*
 * MATLAB INTERNAL USE ONLY :: disconnect from external target
 */
EXTERN_C LIBEMLRT_API void emlrtExtDisconnect(struct emlrtExternalSim *aExternalSim);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtExportNumericArrayR2013a(emlrtCTX aTLS, const mxArray *aOut, const void *aInData, int32_T aElementSize);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtNameCapturePostProcessR2012a(const mxArray * const mxInfo);
 ...
 */
EXTERN_C LIBEMLRT_API emlrtCTX emlrtAllocTLS(emlrtCTX aMaster, int32_T aTeamTID);
